...
__SUPPORTED_MODEL_REGEX_STRING = (
    ...
    rf"|(?P<{SupportedModels.AFG31021.value}>^AFG31021$)"
    rf"|(?P<{SupportedModels.AFG31022.value}>^AFG31022$)"
    rf"|(?P<{SupportedModels.AFG31051.value}>^AFG31051$)"
    rf"|(?P<{SupportedModels.AFG31052.value}>^AFG31052$)"
    rf"|(?P<{SupportedModels.AFG31101.value}>^AFG31101$)"
    rf"|(?P<{SupportedModels.AFG31102.value}>^AFG31102$)"
    rf"|(?P<{SupportedModels.AFG31151.value}>^AFG31151$)"
    rf"|(?P<{SupportedModels.AFG31152.value}>^AFG31152$)"
    rf"|(?P<{SupportedModels.AFG31251.value}>^AFG31251$)"
